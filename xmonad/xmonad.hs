...
--
myWorkspaces    = [" >_ "," web "," edit "," read "," mus "," vid "," 7 "," 8 "," 9 "]

-- Border colors for unfocused and focused windows, respectively.
--
myNormalBorderColor  = "#000000"
myFocusedBorderColor = "#1b7df5"
...
myTabTheme = def { fontName            = myFont
                 ...
                 , inactiveBorderColor = "#bbc2cf"
                 , activeTextColor     = "#bbc2cf"
...
myShowWNameTheme = def
    { swn_font              = "xft:Georgia:bold:size=60"
    , swn_fade              = 0.1
    , swn_bgcolor           = "#1c1f24"
    , swn_color             = "#32a852"
    }
...
main = do
  xmproc <- spawnPipe "xmobar -x 0 /home/moazzam/.config/xmobar/xmobar.config" 
